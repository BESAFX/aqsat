...
public class CompanyRest {
    ...
    public Company update(@RequestBody Company company, Principal principal) {
        ...
        if (object != null) {
            ...
            notificationService.notifyOne(Notification.builder().message(lang.equals("AR") ? "تم تعديل بيانات الشركة بنجاح" : "Update company information successfully").type("warning").build(), principal.getName());
            return company;
        } else {
            return null;
        }
